...
├── HelloEndpointTest.java                        # Public /hello endpoint
...
### 4. Public Endpoints
Tests that public endpoints (`/hello`, `/shortprofile`, `/checkpost`) are accessible without authentication.
...
| `/hello` | permitAll() | HelloEndpointTest | 4 |
