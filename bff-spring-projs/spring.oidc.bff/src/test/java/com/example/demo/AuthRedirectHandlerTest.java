 ...
 *
 *   source == "swagger"   → swaggerUiBaseUrl (if set) else /swagger-ui/index.html
...
@SpringBootTest(properties = {
    ...
    "swaggeruiurl=http://localhost:5000"
})
...
public class AuthRedirectHandlerTest {
    ...
    /**
     * source == "swagger" with swaggeruiurl configured → redirect to swaggeruiurl.
     */
    @Test
    void successHandler_SourceSwagger_WithSwaggerUrl_RedirectsToSwaggerUrl() throws Exception {
        org.springframework.mock.web.MockHttpServletRequest request =
            new org.springframework.mock.web.MockHttpServletRequest();
        org.springframework.mock.web.MockHttpServletResponse response =
            new org.springframework.mock.web.MockHttpServletResponse();

        request.getSession(true).setAttribute("source", "swagger");

        customSuccessHandler.onAuthenticationSuccess(request, response,
            dummyAuthentication());

        org.junit.jupiter.api.Assertions.assertEquals("http://localhost:5000",
     ...
     */
    @Test
    void failureHandler_SourceSwagger_WithSwaggerUrl_RedirectsToSwaggerUrl() throws Exception {
        org.springframework.mock.web.MockHttpServletRequest request =
            new org.springframework.mock.web.MockHttpServletRequest();
        org.springframework.mock.web.MockHttpServletResponse response =
            new org.springframework.mock.web.MockHttpServletResponse();
    ...
    void failureHandler_SourceSwagger_SessionAttributeRemovedAfterUse() throws Exception {
        ...
        session.setAttribute("source", "swagger");
