...
public class CorsEnabledModeTest {
    ...
    /**
     * When only febaseurl is set (no swaggeruiurl), a preflight from the Swagger UI origin
     * must be rejected — it was not added to the allowed origins list.
     */
    @Test
    void preflight_FromSwaggerOriginWhenNotConfigured_Returns403() throws Exception {
        mockMvc.perform(options("/shortprofile")
