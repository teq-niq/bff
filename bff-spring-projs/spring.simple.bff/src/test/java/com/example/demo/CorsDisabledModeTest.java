...
/**
 * CORS tests for the "all-in-one" deployment mode — neither febaseurl nor
 * swaggeruiurl is set, so SecurityConfiguration takes the else-branch:
 ...
 * or swaggeruiurl, which is exactly the all-in-one scenario.
 */
@SpringBootTest
